        ...
        <div class="container">
            <div class="row pull-left">
                ...
                <div id="secondary" class="widget-area col-sm-12 col-md-8" role="complementary">
                    ...
                    <h3 style="color: #6eba3c;">Academy DS에 오신것을 환영합니다.</h3>
                    <p  style="text-align: left;">
                        안녕하세요! Academy DS 교육훈련원장입니다. Academy DS를 방문하여 주셔서 감사합니다!</br>
                        </br>
                        우리 조선&해양은 국가적 사업으로 세계 최고를 지향하고 있으며, Academy DS는 이러한 비전의 성공적 달성과 더불어 우리나라 해운, 조선산업 등 관련분야의 인재양성에 이바지 하고자 설립되었습니다.</br>
                        </br>
                        Academy DS를 통해 선급업무와 관련된 국제협약 및 선급기술 등 각 분야별 전문지식과 변경사항에 대하여, 축적된 기술력과 교육과정을 바탕으로 해운, 조선업계 종사자들의 니즈를 적극적으로 반영한 교육과정을 개발, 운영해 나가도록 하겠으며, 이를 통해 Academy DS는 분야별 최신화된 정보를 학습하고 적용할 수 있는 최고 전문가 학습의 장이 될 수 있도록 하겠습니다.</br>
                    </p>
                </div>
            </div>
        </div>
